...
#   Author: qinghuan <a3299lhra@gmail.com>                        #
...
echo "# Author: qinghuan <a3299lhra@gmail.com>                    #"
echo "# Github: https://github.com/LiHaoran0321/sh-Repository     #"
echo "#############################################################"
echo

libsodium_file="libsodium-1.0.17"
libsodium_url="https://github.com/LiHaoran0321/sh-Repository/blob/master/libsodium-1.0.17.tar.gz"
shadowsocks_r_file="shadowsocksr-3.2.2"
shadowsocks_r_url="https://github.com/LiHaoran0321/sh-Repository/releases/download/ssr/shadowsocksr-3.2.2.tar.gz"
...
install(){
    ...
    if [ -f /usr/local/shadowsocks/server.py ]; then
        ...
        echo "ShadowsocksR install failed, please Email to qinghuan <a3299lhra@gmail.com> and contact"
        install_cleanup
        exit 1
    fi
}
